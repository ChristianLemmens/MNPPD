...
def get_1sigma(outputpath,param,shortlong):
    ...
    if shortlong == 'short':
        ...
        a = pymultinest.Analyzer(23, outputfiles_basename = outputpath + "/test-")
        ...
        a = pymultinest.Analyzer(20, outputfiles_basename = outputpath + "/test-")
...
def get_all1sigma(outputpath,n_params,region):
    if "parameters1sigma.csv" not in listdir(outputpath):
        ...
        for parameter in params:
            output = output.append([get_1sigma(outputpath,parameter,shortlong)],ignore_index=True)
